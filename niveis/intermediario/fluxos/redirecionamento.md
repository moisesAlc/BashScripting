...
## ↔️ Comandos de Redirecionamento
...
#### ▫️ ▫️ Como Funciona o Here Document
...
- ⌨️ ```comando```: o comando que receberá o texto como entrada.
...
- ⚠️ Dados Binários: Embora here documents sejam geralmente usados para texto, alguns usos especiais podem incluir dados binários, que precisam ser manipulados com cuidado para evitar problemas de codificação.
