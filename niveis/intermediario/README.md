...
8. ↔️ [Redirecionamento](fluxos/redirecionamento.md) — `stdin` / `stdout` / `stderr`
9. ⌨️ [IFS](fluxos/IFS.md) — parsing de campos e `while read`
10. 📚 [Arrays](arrays/arrays.md)
11. 🖥️ [tmux](tmux/tmux.md) — sessões no terminal *(opcional)*
